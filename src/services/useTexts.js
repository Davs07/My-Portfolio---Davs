          ...
          list: [
            {
              ...
              link: "https://mando.uno/comercios",
              linkText: "mando.uno/comercios",
            },
            {
              name: "MANDO Marketplace",
              badge: "Marketplace & CMS",
              image: "https://placehold.co/800x450/f1f5f9/334155?text=MANDO+Marketplace",
              imageAlt: "MANDO Marketplace screenshot",
              description: "MandoShop is a public multi-sector marketplace (retail, restaurant, services) managed by an internal CMS (mando-admin).",
              detail: "Combines a catalog with Typesense full-text search, interactive Mapbox map, cookieless personalized recommendations, multi-business Zustand cart, and ProntoPaga checkout.",
              tasks: [
                "Development of MandoShop with Next.js 15 App Router, SSR, ISR, and dynamic sitemap generated via API pagination.",
                "Building a dynamic CMS layout system with 14 configurable section types and automatic merge with local fallback.",
                "Integration of ProntoPaga gateway with a 2-phase checkout supporting multiple methods (card, QR, Yape) with state polling.",
                "Implementation of full-text search with Typesense and interactive business map with Mapbox GL.",
                "Design of personalized recommendation system based on local history, and development of mando-admin (internal Next.js 14 panel) with Clerk RBAC and Typesense DevOps."
              ],
              techs: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Zustand", "TanStack Query", "Typesense", "Mapbox GL", "ProntoPaga", "Clerk", "Upstash Vector", "Resend", "GSAP"],
        ...
        projects: {
          list: [
            ...
            },
            {
              ...
              badge: "Marketplace & CMS",
              image: "https://placehold.co/800x450/f1f5f9/334155?text=MANDO+Marketplace",
              imageAlt: "Captura de MANDO Marketplace",
              description: "MandoShop es un marketplace público multi-sector (tiendas, restaurantes, servicios) gestionado por un CMS interno (mando-admin).",
              detail: "Combina un catálogo con búsqueda full-text Typesense, mapa interactivo Mapbox, recomendaciones personalizadas sin login, carrito multi-negocio con Zustand y checkout con ProntoPaga.",
              tasks: [
                "Desarrollo de MandoShop con Next.js 15 App Router, SSR, ISR y sitemap dinámico generado por paginación desde la API.",
                "Construcción de un sistema de layout CMS dinámico con 14 tipos de secciones configurables y merge automático con fallback local.",
                "Integración de pasarela ProntoPaga con checkout de 2 fases, soportando múltiples métodos (tarjeta, QR, Yape) con polling de estado.",
                "Implementación de búsqueda full-text con Typesense y mapa interactivo de negocios con Mapbox GL.",
                "Diseño de sistema de recomendaciones personalizadas basado en historial local, y desarrollo de mando-admin (panel interno Next.js 14) con RBAC en Clerk y Typesense DevOps."
              ],
              techs: ["Next.js", "React", "TypeScript", "Tailwind CSS", "Zustand", "TanStack Query", "Typesense", "Mapbox GL", "ProntoPaga", "Clerk", "Upstash Vector", "Resend", "GSAP"],
              link: "https://mando.uno",
              linkText: "mando.uno",

...
export const useTexts = () => {
  ...
  const allEnglish = !changeLanguage
    ? {
          ...
          list: [
            {
              ...
              tasks: [
                "Backend development with NestJS, TypeScript and Prisma ORM.",
                "Frontend development with Next.js, React, TailwindCSS, Radix UI, Zustand and React Query.",
                "Integration of services like Clerk, Upstash Redis, Cloudinary, Resend, OpenAI and maps APIs.",
                "Features like QR scanning, PDF/Excel export and data visualization with Recharts.",
                "Development of the basic marketplace MandoShop to connect businesses with customers.",
              ],
              techs: ["NestJS", "Next.js", "React", "TypeScript", "Prisma", "TailwindCSS", "Radix UI", "Zustand", "React Query", "Upstash Redis", "Cloudinary", "Resend", "OpenAI", "Mapbox", "Recharts"],
        ...
        skillCategories: [
          { label: "Frontend", skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Zustand", "React Query", "Radix UI"] },
          { label: "Backend", skills: ["Laravel", "PHP", "NestJS", "Node.js", "Prisma", "REST APIs", "WebSockets"] },
          { label: "Infrastructure", skills: ["AWS", "S3", "CloudFront", "SES", "SQS", "Redis", "Reverb"] },
          { label: "Integrations", skills: ["Yapago", "Shinkansen", "Clerk", "Cloudinary", "Resend", "OpenAI", "Mapbox", "Google Maps"] },
          { label: "Tools", skills: ["Git", "GitHub", "VS Code", "Figma", "Postman", "Docker"] },
        ],
        about: {
    ...
    : {
          ...
          list: [
            {
              ...
              tasks: [
                "Desarrollo del backend con NestJS, TypeScript y Prisma ORM.",
                "Desarrollo del frontend con Next.js, React, TailwindCSS, Radix UI, Zustand y React Query.",
                "Integración de servicios como Clerk, Upstash Redis, Cloudinary, Resend, OpenAI y APIs de mapas.",
                "Funcionalidades como escaneo QR, exportación a PDF/Excel y visualización de datos con Recharts.",
                "Desarrollo del marketplace básico MandoShop para conectar negocios con clientes.",
              ],
              techs: ["NestJS", "Next.js", "React", "TypeScript", "Prisma", "TailwindCSS", "Radix UI", "Zustand", "React Query", "Upstash Redis", "Cloudinary", "Resend", "OpenAI", "Mapbox", "Recharts"],
              link: "https://mando.uno",
              linkText: "mando.uno",
        ...
        skillCategories: [
          { label: "Frontend", skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Zustand", "React Query", "Radix UI"] },
          { label: "Backend", skills: ["Laravel", "PHP", "NestJS", "Node.js", "Prisma", "REST APIs", "WebSockets"] },
          { label: "Infraestructura", skills: ["AWS", "S3", "CloudFront", "SES", "SQS", "Redis", "Reverb"] },
          { label: "Integraciones", skills: ["Yapago", "Shinkansen", "Clerk", "Cloudinary", "Resend", "OpenAI", "Mapbox", "Google Maps"] },
          { label: "Herramientas", skills: ["Git", "GitHub", "VS Code", "Figma", "Postman", "Docker"] },
        ],
        about: {
